//*************************************************************************
//* File Name: power_fun.cpp
//* Author:GeekBear
//* Mail:zeerre98988@gmail.com 
//* Created And Modified Time: ====2022-01-10  18-55-44====
//*************************************************************************

#include "power_fun.h"
void power_bit_print(long long x){
    long long i=0,ii=0,num=0;
    int bit[N];
    while(x){
        if(x&1){
            num+=1;
